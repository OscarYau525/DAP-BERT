...
def main():
    ...
    tokenizer = BertTokenizer.from_pretrained(args.pretrained_bert_model, cache_dir=args.cache_dir, do_lower_case=args.do_lower_case)
    model = BertForMaskedLM.from_pretrained(args.pretrained_bert_model, cache_dir=args.cache_dir)
    model.eval()
